        ...
        return (
            <>
                <div onWheel={this.handleWheel}>
                    <Chessground
                        width={window.innerWidth < 880 ? "90vw" : ""}
                        ...
                        ref={el => this.chessground = el}
                    />
                </div>
                <br/>
                <Grid container alignItems="center" direction={"row"} justify={"center"}>
                    <Button onClick={this.toFirst}><FastRewindTwoToneIcon/></Button>
                    <Button variant={"contained"} style={{backgroundColor: "#00CED1"}}
                            onClick={this.toPrev}><SkipPreviousTwoToneIcon/></Button>
                    <Button variant={"contained"} style={{backgroundColor: "#00CED1"}}
                            onClick={this.toNext}><SkipNextTwoToneIcon/></Button>
                    <Button onClick={this.toLast}><FastForwardTwoToneIcon/></Button>
                    <Button variant={"contained"} color={"primary"}
                            onClick={this.props.onFlip}><SwapVertTwoToneIcon/></Button>
                </Grid>
                <br/>
            </>
        )
