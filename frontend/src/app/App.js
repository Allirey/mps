...
import {orange, lightBlue, green, cyan} from "@material-ui/core/colors";
...
function App(props) {
   ...
   const {notifications, authStore} = props.stores
   const {theme} = authStore

   const mainPrimaryColor = theme === 'dark' ? orange[600] : lightBlue[200];
   const mainSecondaryColor = theme === 'dark' ? cyan[800] : green[200];
   const defaultBackgroundColor = theme === 'dark' ? '#303030': '#edebe9';
